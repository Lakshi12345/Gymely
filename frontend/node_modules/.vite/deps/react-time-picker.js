...
function Divider({ children }) {
  return (0, import_jsx_runtime6.jsx)("span", { className: "react-time-picker__inputGroup__divider", "data-testid": "divider", children });
}
...
function getNumberFormatter(options) {
  return (locale, number) => {
    ...
    if (!numberFormatterCacheLocale.has(options)) {
      const formatter = new Intl.NumberFormat(localeWithDefault || void 0, options);
...
// node_modules/react-time-picker/dist/TimeInput/AmPm.js
function AmPm({ ariaLabel, autoFocus, className, disabled, form, inputRef, locale, maxTime, minTime, onChange, onKeyDown, required, value }) {
...
// node_modules/update-input-width/dist/index.js
...
var dist_default4 = updateInputWidth;
...
function Input({ ariaLabel, autoFocus, className, disabled, form, inputRef, max, min, name, nameForClass, onChange, onKeyDown, onKeyUp, placeholder = "--", required, showLeadingZeros, step, value }) {
  useIsomorphicLayoutEffect(() => {
    if (!(inputRef === null || inputRef === void 0 ? void 0 : inputRef.current)) {
      return;
    }
    dist_default4(inputRef.current);
...
function renderCustomInputs(placeholder, elementFunctions, allowMultipleInstances) {
  ...
  return placeholder.split(pattern).reduce((arr, element, index) => {
    const divider = element && (0, import_jsx_runtime14.jsx)(Divider, { children: element }, `separator_${index}`);
    arr.push(divider);
...
function TimeInput({ amPmAriaLabel, autoFocus, className, customInputsForm, disabled, format, hourAriaLabel, hourPlaceholder, isClockOpen: isClockOpenProps = null, locale, maxDetail = "minute", maxTime, minTime, minuteAriaLabel, minutePlaceholder, name = "time", nativeInputAriaLabel, onChange: onChangeProps, onInvalidChange, required, secondAriaLabel, secondPlaceholder, value: valueProps }) {
  ...
  const previousValueProps = (0, import_react5.useRef)(valueProps);
  ...
  return (0, import_jsx_runtime14.jsxs)("div", { className, onClick, children: [renderNativeInput(), renderCustomInputsInternal()] });
}
...
function TimePicker(props) {
  ...
  function renderInputs() {
    ...
    return (0, import_jsx_runtime15.jsxs)("div", { className: `${baseClassName}__wrapper`, children: [(0, import_jsx_runtime15.jsx)(TimeInput, { ...ariaLabelProps, ...placeholderProps, autoFocus, className: `${baseClassName}__inputGroup`, customInputsForm, disabled, format, isClockOpen: isOpen, locale, maxDetail, maxTime, minTime, name, onChange, onInvalidChange, required, value: valueFrom }), clearIcon !== null && (0, import_jsx_runtime15.jsx)("button", { "aria-label": clearAriaLabel, className: `${baseClassName}__clear-button ${baseClassName}__button`, "data-testid": "clear-button", disabled, onClick: clear, onFocus: stopPropagation, type: "button", children: typeof clearIcon === "function" ? (0, import_react6.createElement)(clearIcon) : clearIcon }), clockIcon !== null && !disableClock && (0, import_jsx_runtime15.jsx)("button", { "aria-expanded": isOpen || false, "aria-label": clockAriaLabel, className: `${baseClassName}__clock-button ${baseClassName}__button`, "data-testid": "clock-button", disabled, onClick: toggleClock, onFocus: stopPropagation, type: "button", children: typeof clockIcon === "function" ? (0, import_react6.createElement)(clockIcon) : clockIcon })] });
  }
  ...
  return (0, import_jsx_runtime15.jsxs)("div", { className: clsx_default(baseClassName, `${baseClassName}--${isOpen ? "open" : "closed"}`, `${baseClassName}--${disabled ? "disabled" : "enabled"}`, className), "data-testid": dataTestid, id, ...eventProps, onFocus: onFocus2, ref: wrapper, children: [renderInputs(), renderClock()] });
}

// node_modules/react-time-picker/dist/index.js
var dist_default5 = TimePicker;
export {
  TimePicker,
