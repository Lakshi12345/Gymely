        ...
        <div className="relative">
            ...
            >
                <span className="mr-3 h-11 w-11 overflow-hidden rounded-full">
                    <img src={`${CDN_URL}/${user?.gymLogo}`} alt="User" />
                </span>
                        ...
                        >
                            ...
                            >
                                <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                                    d="M12 12C14.2091 12 16 10.2091 16 8C16 5.79086 14.2091 4 12 4C9.79086 4 8 5.79086 8 8C8 10.2091 9.79086 12 12 12ZM12 5.5C13.3807 5.5 14.5 6.61929 14.5 8C14.5 9.38071 13.3807 10.5 12 10.5C10.6193 10.5 9.5 9.38071 9.5 8C9.5 6.61929 10.6193 5.5 12 5.5ZM5 20C5 16.134 8.13401 13 12 13C15.866 13 19 16.134 19 20V21H5V20ZM6.55 19.5H17.45C17.2066 16.686 14.8456 14.5 12 14.5C9.15443 14.5 6.79337 16.686 6.55 19.5Z"
                                    fill=""
                                />
                                <path
                                    d="M18 11C19.6569 11 21 9.65685 21 8C21 6.34315 19.6569 5 18 5C17.4877 5 17.0057 5.12854 16.5815 5.355C17.0375 6.10653 17.25 7.00204 17.25 8C17.25 9.04108 17.0107 9.97399 16.5031 10.7508C16.9461 10.908 17.4491 11 18 11Z"
                                    fill=""
                                />
                                <path
                                    d="M18 12.5C17.4784 12.5 16.9713 12.5641 16.4854 12.6848C17.9127 13.8508 18.9077 15.4597 19.2539 17.2954C19.8129 17.5229 20.4208 17.6554 21.059 17.6554H22V17C22 14.5147 20.4853 12.5 18 12.5Z"
                                    fill=""
                                />
                            </svg>
                            Team & Access
